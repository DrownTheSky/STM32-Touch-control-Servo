...
#define LCD_LAYER1_START_ADDR       ((uint32_t)0xD0000000)		//（底层）第一层首地址
#define BUFFER_OFFSET               ((uint32_t)800*480*4)     //一层液晶的数据量
#define LCD_LAYER2_START_ADDR       (LCD_LAYER1_START_ADDR + BUFFER_OFFSET + 200)		  //（顶层）第二层首地址
