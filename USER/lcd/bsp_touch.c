...
extern void GT91x_Touch_Down(uint8_t TrackID, int16_t PointX, int16_t PointY, int16_t PointS);
extern void GT91x_Touch_UP(uint8_t TrackID, int16_t PointX, int16_t PointY, int16_t PointS);
