...
void Touch_Button_Down(uint16_t x,uint16_t y)
{
	...
	{
			BEEP_ON;
			LCD_DrawFullCircle(150,150,50,LCD_LAYER1_START_ADDR,0xFFFFFFFF);
	}
	else
	{
		LCD_DrawFullCircle(150,150,50,LCD_LAYER1_START_ADDR,0xFF00FFFF);
	}
	
		if((x<200)&(x>100)&(y<380)&(y>280))
	{
			BEEP_ON;
			LCD_DrawFullCircle(150,330,50,LCD_LAYER1_START_ADDR,0xFFFFFFFF);
	}
	else
	{
		LCD_DrawFullCircle(150,330,50,LCD_LAYER1_START_ADDR,0xFF00FFFF);
	}
	
	
	
	
	if((x<375)&(x>250)&(y<440)&(y>40))
	{
		
		LCD_DrawFullRect(300, y-25, 50, 50,LCD_LAYER1_START_ADDR, 0xFF000000);
		LCD_DrawFullRect(300, 0, 50, y-25,LCD_LAYER1_START_ADDR, 0xFFFFFFFF);
		LCD_DrawFullRect(300, y+25, 50, 480,LCD_LAYER1_START_ADDR, 0xFFFFFFFF);
		
		ChannelPulse = (((y-40)/2)+50) ;
